...
import Elm.Project
import Elm.Version
import Evergreen.V30.PackageStatus
import Http
import Lamdera
import Set
import Url
...
type PackageStatusFrontend
    ...
    | FetchedAndChecked_
        { version : Elm.Version.Version
        , updateIndex : Int
        , result : Evergreen.V30.PackageStatus.ReviewResult
        }
...
type alias BackendModel =
    { cachedPackages : Dict.Dict String (AssocList.Dict Elm.Version.Version Evergreen.V30.PackageStatus.PackageStatus)
...
type BackendMsg
    ...
    | RanNoUnused
        ...
        Evergreen.V30.PackageStatus.ReviewResult
