...
import Elm.Project
import Elm.Version
import Evergreen.V38.PackageStatus
import Http
import Lamdera
import Set
import Time
...
type PackageStatusFrontend
    ...
    | FetchedAndChecked_
        { updateIndex : Int
        , result : Evergreen.V38.PackageStatus.ReviewResult
        }
...
type alias BackendModel =
    { cachedPackages : Dict.Dict String (AssocList.Dict Elm.Version.Version Evergreen.V38.PackageStatus.PackageStatus)
...
type BackendMsg
    ...
    | RanNoUnused
        ...
        Evergreen.V38.PackageStatus.ReviewResult_
    ...
    | ReranPackage
        ...
        Evergreen.V38.PackageStatus.ReviewResult
