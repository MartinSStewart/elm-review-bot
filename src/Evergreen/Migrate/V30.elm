...
import AssocList
import Dict
import Evergreen.V21.PackageStatus as OldPackageStatus
import Evergreen.V21.Types as Old
import Evergreen.V30.PackageStatus as NewPackageStatus
...
migrateRunRuleResult ruleResult =
    case ruleResult of
        OldPackageStatus.ParsingError ->
            NewPackageStatus.ParsingError (List.Nonempty.fromElement "")
